...
PARAM_ARGS=(
  -p "store_uniswap_v3_pools=uniswap_v3_factory=${UNISWAP_V3_FACTORY}"
  -p "store_uniswap_v3_pool_meta=uniswap_v3_factory=${UNISWAP_V3_FACTORY}"
  -p "map_events=uniswap_v3_factory=${UNISWAP_V3_FACTORY}&oapp_address=${OAPP_ADDRESS}&usd_token_address=${USD_TOKEN_ADDRESS}&usd_token_decimals=${USD_TOKEN_DECIMALS}&launchpad_usd_decimals=${LAUNCHPAD_USD_DECIMALS}&default_token_decimals=${DEFAULT_TOKEN_DECIMALS}&default_token_supply=${DEFAULT_TOKEN_SUPPLY}"
)
