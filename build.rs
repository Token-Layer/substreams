...
fn main() -> Result<(), anyhow::Error> {
    let file_names = [
        "abi/registry_contract.abi.json",
        "abi/oapp_contract.abi.json",
        "abi/manager_contract.abi.json",
        "abi/launchpad_contract.abi.json",
        "abi/ip_contract.abi.json",
        "abi/liquidity_mananager_contract.abi.json",
        "abi/fees_contract.abi.json",
        "abi/roles_contract.abi.json",
        "abi/token_coin_contract.abi.json",
    ];
    let file_output_names = [
        "src/abi/registry_contract.rs",
        "src/abi/oapp_contract.rs",
        "src/abi/manager_contract.rs",
        "src/abi/launchpad_contract.rs",
        "src/abi/ip_contract.rs",
        "src/abi/liquidity_mananager_contract.rs",
        "src/abi/fees_contract.rs",
